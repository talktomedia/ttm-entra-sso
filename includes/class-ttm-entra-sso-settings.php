...
final class TTM_Entra_SSO_Settings {
    ...
    public static function maybe_repair_defaults(): void {
        ...
        if ( is_array( $stored ) && ! empty( $stored ) ) {
            ...
            // Force default_role to ttm_site_editor regardless of what it was before, because the plugin now requires that role to exist and be used for auto-created users.
            $stored['default_role'] = 'ttm_site_editor';
